...
public class OntologyReasonerService {
    ...
    public static void init_map(){
        ...
        prefix_map.put("http://localhost/KGns/relationship/contain", "rel:contain");
        prefix_map.put("http://localhost/KGns/relationship/provide", "rel:provide");
    ...
    public static void OntologyReasoning(){
        ...
        ontologyModel.read("data/data_v3_1.ttl");
